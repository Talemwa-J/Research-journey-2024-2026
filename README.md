...
Implements a **Random Forest machine learning model** to predict CO₂ emissions based on land-use and socio-economic variables.
...
This dataset is used for statistical analysis and machine learning modeling.
...
LaTeX template used to format the research paper according to **PLOS journal guidelines**.

### plos_bibtex_sample.bib

BibTeX reference file used to manage citations in the manuscript.
...
```
git clone https://github.com/Talemwa-J/Research-journey-2024-2026.git
```

2. Open MATLAB and navigate to the project folder.

3. Run the scripts for:
